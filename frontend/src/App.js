    ...
    const theme = createTheme(
        {
            ...
            palette: {
                type: mode,
                primary: { main: mode === "light" ? "#148C3D" : "#FFFFFF" },
                textPrimary: mode === "light" ? "#148C3D" : "#FFFFFF",
                borderPrimary: mode === "light" ? "#148C3D" : "#FFFFFF",
                ...
                barraSuperior: mode === "light" ? "linear-gradient(to right, #148C3D, #148C3D , #148C3D)" : "#666",
